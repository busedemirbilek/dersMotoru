    ...
    <Modal
      ...
      <View
        ...
        <View
          ...
          <Text style={{fontSize: 28, color: COLORS.black}}>Sonuçlar</Text>
          <View
            style={{
              flexDirection: 'row',
              alignItems: 'center',
            ...
            <View style={{alignItems: 'center', padding: 20}}>
              ...
              <Text style={{fontSize: 16}}>Doğru</Text>
            </View>
            <View style={{alignItems: 'center', padding: 20}}>
              <Text style={{color: COLORS.error, fontSize: 30}}>
                {incorrectCount}
              </Text>
              <Text style={{fontSize: 16}}>Yanlış</Text>
            </View>
          </View>
          <Text style={{opacity: 0.8}}>
            {totalCount - (incorrectCount + correctCount)} Boş Cevap
          </Text>
